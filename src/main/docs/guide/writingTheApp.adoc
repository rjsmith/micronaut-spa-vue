...
Additionally, there is a directory named `client` which contains a VueJS single-page-app. The project was generated using the Vue CLI `vue create client`, and has no modifications. If you have `yarn` installed and a Node.js installation of `10.x` or above, you can run the app as shown below:
